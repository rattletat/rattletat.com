d3.json("/staticfiles/events/data/world-110m.json", function (error, world) {
  if (error) {
  ...
  !(function () {
    ...
    function u(t) {
      for (var n = 0, e = arguments.length, o = []; ++n < e; )
        o.push(arguments[n]);
          ...
          .on("zoomstart", function () {
            ...
            u && (M = u),
              g.call(p, "zoom", function () {
                ...
                var e = d3.mouse(this),
                  s = a(M, n(f, e));
                f.rotate((z.r = i((c = s ? o(c, s) : o(t(f, r, e), c))))),
                  (r = e),
                  h(v.of(this, arguments));
              }),
      ...
      return (
        ...
        (p.projection = function (t) {
          return arguments.length
            ? ((f = t), (z = { r: f.rotate(), k: f.scale() }), p.scale(z.k))
            : f;
        }),
              ...
              a.each("start.zoom", function () {
                ...
                .tween("zoom:zoom", function () {
                  ...
                  return (
                    ...
                    function (e) {
                      var o = u(e);
                      (this.__chart__ = z = { r: i(c(o[0] / s)), k: t / o[2] }),
                        f.rotate(z.r).scale(z.k),
                        p.scale(z.k),
                        h(n);
                    }
    ...
    (function () {
      ...
      d3.json("../world-110m.json", function (t, r) {
        function l() {
          f(i, p[(g = ((z = g) + 1) % p.length)]),
            c
              .transition()
              .ease("quad-in-out")
              .duration(2e3)
              .call(y.projection(i).event);
        }
        function f(t, n) {
          ...
          var i = h.bounds(n),
            c = Math.min(
              ...
              0.45 /
                Math.max(
                  Math.max(Math.abs(i[1][0]), Math.abs(i[0][0])) / o,
                  Math.max(Math.abs(i[1][1]), Math.abs(i[0][1])) / a
                )
            );
          t.clipExtent(r)
            .scale(c)
        ...
        var d = { type: "Sphere" },
          ...
          y = d3.geo
            ...
            .on("zoom", function () {
              i.clipAngle(
                Math.asin(
                  Math.min(1, (0.5 * Math.sqrt(o * o + a * a)) / i.scale())
                ) * n
              ),
